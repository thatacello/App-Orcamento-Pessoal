...
class BD {
    ...
    gravar(d) {
        ...
        // JSON.parse(produto) -> converte JSON em objeto literal
...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()) {
        ...
        document.getElementById('modal_conteudo').innerHTML = 'Despesa com cadastrada com sucesso!'
        ...
        // apaga os campos preenchidos pelo usuário
        ano.value = ''
        mes.value = ''
        ano.value = ''
        tipo.value = ''
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    // seleciona elemento tbady da tabela
    ...
    */
    ...
    despesas.forEach(function(d){
        ...
        btn.onclick = function() { // remover a despesa
            ...
            let id = this.id.replace('id_despesa_', '') // remover 'id_despesa_' do nome do id
            
            bd.remover(id)

            window.location.reload() // atualiza a página -> F5
        }
